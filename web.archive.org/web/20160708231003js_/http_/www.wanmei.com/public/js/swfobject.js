...
var PWRD_SWFPATH="https://web.archive.org/web/20160708231003/http://www.wanmei.com/public/swf/";
var _swfStyleClass;
function addSWF(src, containerID, width, height, argObj)
{
	...
	swfobject.embedSWF(src, containerID, width, height, version, "https://web.archive.org/web/20160708231003/http://www.adobe.com/cfusion/knowledgebase/index.cfm?id=6a253b75", flashVars, params, attributes, addedSWF);
}
...
function addVideo(containerID, width, height, params)
{
	if(params)
	{
		...
		params['configPath'] = params['configPath'] || 'https://web.archive.org/web/20160708231003/http://www.wanmei.com/public/swf/player_config.xml';
	}
...
/*
     FILE ARCHIVED ON 23:10:03 Jul 08, 2016 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 16:36:19 Jun 21, 2025.
...
playback timings (ms):
  ...
  esindex: 0.014
  cdx.remote: 7.122
  LoadShardBlock: 337.496 (3)
  PetaboxLoader3.resolve: 251.454 (4)
  PetaboxLoader3.datanode: 231.865 (5)
  load_resource: 181.588 (2)
*/