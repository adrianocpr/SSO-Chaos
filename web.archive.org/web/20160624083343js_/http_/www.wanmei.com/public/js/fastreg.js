...
(function() {	
    ...
    function getCaptchaImg(){   
        ...
        return 'https://web.archive.org/web/20160624083343/http://captchas.wanmei.com/captcha/wanmeiDomainCaptcha?appId=3f44f969da61475c8424a0ce3b4cd661&time=' + t    
    }
	...
	var util = {
		jsonp: function(method, params, callback) {
			var url;
			if (method == "register") {
				url = "https://web.archive.org/web/20160624083343/http://passport.wanmei.com/member/fastreg/v3.do"
			}else if(method == "addIndulge"){ 
                url = "https://web.archive.org/web/20160624083343/http://passport.wanmei.com/member/fastreg/v1.do"               
            } else if(method == 'checkRandom'){ 
                url = "https://web.archive.org/web/20160624083343/http://passport.wanmei.com/ajax/checkrand"            
            }else if(method == 'sendCode'){ 
                url = 'https://web.archive.org/web/20160624083343/http://passport.wanmei.com/ajax/sendcode'
            }else{
				url = "https://web.archive.org/web/20160624083343/http://passport.wanmei.com/member/common/v1.do"
			}
	...
	var reg = {
		...
		changeSmsCaptcha: function(){
			this.$el.find(".qreg-smscaptcha-img").attr("src",getCaptchaImg())
		},
		submitSmsCaptcha: function(){
		...
		template: function(type) {
			...
			html += '已阅读并同意<a href="https://web.archive.org/web/20160624083343/http://passport.wanmei.com/jsp/member/agreement.htm" target="_blank">用户协议及防沉迷协议</a> </label>'
			html += '</div>'
			html += '</div>'
	...
	var regSuc = {
		...
		bindEvents: function() {
			this.$el.on('click', '.qreg-btn-tobind', function() {
				app.router('regBind')
			})
			this.$el.on('click', '.qreg-btn-back', function() {
				if(app.data.backUrl){	
...
/*
     FILE ARCHIVED ON 08:33:43 Jun 24, 2016 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 16:36:26 Jun 21, 2025.
...
playback timings (ms):
  ...
  esindex: 0.017
  cdx.remote: 13.409
  LoadShardBlock: 111.971 (3)
  PetaboxLoader3.datanode: 127.192 (4)
  load_resource: 150.354
  PetaboxLoader3.resolve: 85.417
*/